...
namespace HPRBackend.Controllers.Gestion_Des_Patient
{
    ...
    [ApiController]
    public class FacturePreAdmissionController : ControllerBase
    {
        public readonly DataBaseContext DataBaseContext;
        public DAL_FacturePreAdmission DAL_Admission;
        public FacturePreAdmissionController(DataBaseContext DataBaseContext)
        {
            this.DataBaseContext = DataBaseContext;

            this.DAL_Admission = new DAL_FacturePreAdmission(DataBaseContext);

        }

        [HttpPost("Add_Or_Update")]
        public async Task<IActionResult> Add_Or_Update(FacturePreAdmission Admission)
        {
